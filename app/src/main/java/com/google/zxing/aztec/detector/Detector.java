...
public final class Detector {
    ...
    private static ResultPoint[] expandSquare(ResultPoint[] resultPointArr, float f, float f2) {
        ...
        return new ResultPoint[]{resultPoint, new ResultPoint((f3 * x) + x2, (f3 * y) + y2), resultPoint2, new ResultPoint(x2 - (x * f3), y2 - (f3 * y))};
    }
    ...
    private ResultPoint[] getBullsEyeCorners(Point point) throws NotFoundException {
        ...
        if (this.nbCenterLayers == 5 || this.nbCenterLayers == 7) {
            ...
            return expandSquare(new ResultPoint[]{new ResultPoint(0.5f + ((float) point4.getX()), ((float) point4.getY()) - 0.5f), new ResultPoint(0.5f + ((float) point3.getX()), ((float) point3.getY()) + 0.5f), new ResultPoint(((float) point2.getX()) - 0.5f, ((float) point2.getY()) + 0.5f), new ResultPoint(((float) point.getX()) - 0.5f, ((float) point.getY()) - 0.5f)}, (float) ((this.nbCenterLayers * 2) - 3), (float) (this.nbCenterLayers * 2));
        }
        throw NotFoundException.getNotFoundInstance();
    }
