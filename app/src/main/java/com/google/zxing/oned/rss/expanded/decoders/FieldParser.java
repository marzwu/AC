...
final class FieldParser {
    ...
    private static String processFixedAI(int i, int i2, String str) throws NotFoundException {
        ...
        substring = new StringBuilder(String.valueOf('(')).append(substring).append(')').append(substring2).toString();
        substring2 = parseFieldsInGeneralPurpose(substring3);
        return substring2 == null ? substring : new StringBuilder(String.valueOf(substring)).append(substring2).toString();
    }
    ...
    private static String processVariableAI(int i, int i2, String str) throws NotFoundException {
        ...
        String stringBuilder = new StringBuilder(String.valueOf('(')).append(substring).append(')').append(substring2).toString();
        substring = parseFieldsInGeneralPurpose(substring3);
        return substring == null ? stringBuilder : new StringBuilder(String.valueOf(stringBuilder)).append(substring).toString();
    }
}
