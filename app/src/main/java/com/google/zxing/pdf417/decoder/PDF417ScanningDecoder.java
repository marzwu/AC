...
public final class PDF417ScanningDecoder {
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, FormatException, ChecksumException {
        ...
        while (i3 < 2) {
            DetectionResultColumn rowIndicatorColumn = resultPoint != null ? getRowIndicatorColumn(bitMatrix, boundingBox, resultPoint, true, i, i2) : detectionResultColumn3;
            detectionResultColumn3 = resultPoint3 != null ? getRowIndicatorColumn(bitMatrix, boundingBox, resultPoint3, false, i, i2) : detectionResultColumn2;
            detectionResult = merge(rowIndicatorColumn, detectionResultColumn3);
            if (detectionResult == null) {
                ...
                detectionResultColumn3 = rowIndicatorColumn;
        ...
        detectionResult.setDetectionResultColumn(barcodeColumnCount, detectionResultColumn3);
    ...
    private static Codeword detectCodeword(BitMatrix bitMatrix, int i, int i2, boolean z, int i3, int i4, int i5, int i6) {
        ...
        return i8 == -1 ? null : new Codeword(i7, adjustCodewordStartColumn, getCodewordBucketNumber(bitCountSum), i8);
    }
    ...
    private static BarcodeMetadata getBarcodeMetadata(DetectionResultRowIndicatorColumn detectionResultRowIndicatorColumn, DetectionResultRowIndicatorColumn detectionResultRowIndicatorColumn2) {
        if (detectionResultRowIndicatorColumn != null) {
            ...
            if (barcodeMetadata != null) {
                ...
                if (barcodeMetadata2 == null || barcodeMetadata.getColumnCount() == barcodeMetadata2.getColumnCount() || barcodeMetadata.getErrorCorrectionLevel() == barcodeMetadata2.getErrorCorrectionLevel()) {
                    return barcodeMetadata;
                }
