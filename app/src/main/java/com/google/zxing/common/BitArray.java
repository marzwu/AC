...
public final class BitArray implements Cloneable {
    ...
    public void reverse() {
        ...
        for (i = 0; i < i4; i++) {
            ...
            j = ((j & 1431655765) << 1) | (1431655765 & (j >> 1));
            j = ((j & 858993459) << 2) | (858993459 & (j >> 2));
            j = ((j & 252645135) << 4) | (252645135 & (j >> 4));
            j = ((j & 16711935) << 8) | (16711935 & (j >> 8));
            iArr[i3 - i] = (int) (((j & 65535) << 16) | (65535 & (j >> 16)));
        }
        if (this.size != i4 * 32) {
