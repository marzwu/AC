...
public final class Detector {
    ...
    private ResultPointsAndTransitions transitionsBetween(ResultPoint resultPoint, ResultPoint resultPoint2) {
        ...
        x = 0;
        while (i6 != y2) {
            boolean z2 = this.image.get(obj != null ? i8 : i6, obj != null ? i6 : i8);
            if (z2 != z) {
                x++;
                z = z2;
            }
        ...
        return new ResultPointsAndTransitions(resultPoint, resultPoint2, x);
    }
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            if (((Integer) entry.getValue()).intValue() == 2) {
                ...
                resultPointsAndTransitionsComparator = resultPoint7;
            }
        }
        if (resultPoint6 == null || resultPoint5 == null || resultPointsAndTransitionsComparator == null) {
            throw NotFoundException.getNotFoundInstance();
        }
        BitMatrix sampleGrid;
        detect = new ResultPoint[]{resultPoint6, resultPoint5, resultPointsAndTransitionsComparator};
