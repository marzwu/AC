...
public final class DataMatrixWriter implements Writer {
    ...
    private static BitMatrix encodeLowLevel(DefaultPlacement defaultPlacement, SymbolInfo symbolInfo) {
        ...
        while (i < symbolDataHeight) {
            ...
            i3 = 0;
            for (int i5 = 0; i5 < symbolDataWidth; i5++) {
                if (i5 % symbolInfo.matrixWidth == 0) {
                    byteMatrix.set(i3, i4, true);
                    i3++;
                }
                byteMatrix.set(i3, i4, defaultPlacement.getBit(i5, i));
                i2 = i3 + 1;
                if (i5 % symbolInfo.matrixWidth == symbolInfo.matrixWidth - 1) {
                    byteMatrix.set(i2, i4, i % 2 == 0);
                    i3 = i2 + 1;
                } else {
                    i3 = i2;
                }
