...
public final class ErrorCorrection {
    ...
    static {
        int i = 1;
        for (int i2 = 0; i2 < MotionEventCompat.ACTION_MASK; i2++) {
            ALOG[i2] = i;
            LOG[i] = i2;
            i *= 2;
            if (i >= 256) {
        ...
        for (int i6 = i; i6 < i + i2; i6++) {
            ...
            while (i5 > 0) {
                if (charAt == 0 || iArr[i5] == 0) {
                    ...
                    cArr[i5] = (char) (cArr[i5 - 1] ^ ALOG[(LOG[charAt] + LOG[iArr[i5]]) % MotionEventCompat.ACTION_MASK]);
                }
                i5--;
            }
            if (charAt == 0 || iArr[0] == 0) {
                ...
                cArr[0] = (char) ALOG[(LOG[charAt] + LOG[iArr[0]]) % MotionEventCompat.ACTION_MASK];
            }
        }
        ...
        if (interleavedBlockCount == 1) {
            ...
            for (int i2 = 0; i2 < interleavedBlockCount; i2++) {
                ...
                while (i < iArr2[i2] * interleavedBlockCount) {
                    int i4 = i3 + 1;
                    stringBuilder.setCharAt(i + symbolInfo.getDataCapacity(), createECCBlock.charAt(i3));
